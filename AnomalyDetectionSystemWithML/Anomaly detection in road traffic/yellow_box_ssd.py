...
def findEstimationZoneYellowBoxCasernes(frame):
    #cv2.line(frame, (550, 400), (550, 860), (0, 255, 0), 5)
    #cv2.line(frame, (600, 400), (600, 860), (0, 255, 0), 5)
    #cv2.line(frame, (650, 400), (650, 860), (0, 255, 0), 5)
    #cv2.line(frame, (350, 400), (350, 860), (0, 255, 0), 5)
    #cv2.line(frame, (400, 400), (400, 860), (0, 255, 0), 5)
    #cv2.line(frame, (450, 400), (450, 860), (0, 255, 0), 5)
    #cv2.line(frame, (500, 400), (500, 860), (0, 255, 0), 5)
    #cv2.line(frame, (700, 400), (700, 860), (0, 255, 0), 5)
    #cv2.line(frame, (750, 400), (750, 860), (0, 255, 0), 5)
    #cv2.line(frame, (800, 400), (800, 860), (0, 255, 0), 5)
    #cv2.line(frame, (850, 400), (850, 860), (0, 255, 0), 5)
    cv2.line(frame, (350, 400), (850, 400), (0, 255, 0), 5)
    cv2.line(frame, (350, 500), (850, 500), (0, 255, 0), 5)
    cv2.line(frame, (350, 600), (850, 600), (0, 255, 0), 5)
    cv2.imshow('Estimation zone', frame)
...
def processFrame(image):
    ...
    findEstimationZoneYellowBoxCasernes(gray_filtered_resize)
    ...
    if totalFrames % conf["track_object"] == 0:
        ...
        for i in np.arange(0, detections.shape[2]):
            ...
            if confidence > conf["confidence"]:
                ...
                if CLASSES[idx] != "car" and CLASSES[idx] != "bus" and CLASSES[idx] != "motorbike" and CLASSES[idx] != "bicycle":
                    continue
    ...
    for (objectID, centroid) in objects.items():
        ...
        # not yet been estimated then estimate it
            ...
            if conf["yellowbox_casernes"]:
                ...
                yCoorA = conf["yellowbox_zone_casernes"]["yCoorA"]
                yCoorB = conf["yellowbox_zone_casernes"]["yCoorB"]
                yCoorC = conf["yellowbox_zone_casernes"]["yCoorC"]
            ...
            # over the limit
            if ((to.firstPoint and to.midPoint and not to.estimated) or (
                    to.midPoint and to.lastPoint and not to.estimated)):
                ...
                for (i, j, k) in points:
                    ...
                    if not conf['test_model']:
                        if math.isnan(timeInSeconds):
                            ...
                            print("Saving data")
                            saveInCsv(objectID, timeInSeconds, csv_name)

                if conf['test_model']:
                    print('Testing extracted time for anomaly')
